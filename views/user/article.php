...
<div class="container">
<h3 style="text-align:center; padding:15px;">Offer your article right now!</h3>
</div>
...
<form action="#" method="POST" enctype="multipart/form-data">
    ...
    <div class="row row-space">
        <div class="col-10">
            <div class="input-group">
                ...
                <input class="input--style-4" type="author" name="author" value="<?php echo $_SESSION['user_name']; ?>" required>
            </div>
        </div>
    </div>
    <div class="row row-space">
    ...
    <div style="padding-top:100px; padding-bottom:50px;">
        <button class="btn btn--radius-2 btn--blue" type="submit" name="submit">Offer article</button>
    </div>
    </div>
