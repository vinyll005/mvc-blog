...
<section class="home-slider owl-carousel">
          ...
          <div class="row d-flex slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="text d-flex align-items-center ftco-animate">
            	<div class="text-2 pb-lg-5 mb-lg-4 px-4 px-md-5">
		            ...
		            <p><a href="/blog" class="btn btn-black px-3 px-md-4 py-3">Read More <span class="icon-arrow_forward ml-lg-4"></span></a></p>
              </div>
            </div>
    		...
    		<div class="row">
    			<div class="col-md-6 order-md-last col-lg-6 ftco-animate">
    				<div class="blog-entry">
    					<div class="img img-big d-flex align-items-end" style="background-image: url(assets/images/image_2.jpg);">
    						<div class="overlay"></div>
    						<div class="text">
    							<span class="subheading">Food</span>
    							<h3><a href="/blog">Tasty &amp; Delicious Foods</a></h3>
    							<p class="mb-0"><a href="/blog" class="btn-custom">Read More <span class="icon-arrow_forward ml-4"></span></a></p>
    						</div>
	    				</div>
    				</div>
    			</div>
    			<div class="col-md-6">
    				<div class="row">
                        <?php for($i = 0; $i < 4; $i++) { 
							$format = 'Y-m-d H:i:s';
							$date = DateTime::createFromFormat($format, $articles[$i]['date']);
							?>
                            <div class="col-md-6 ftco-animate">
    						<div class="blog-entry">
		    					<a href="article/<?php echo $articles[$i]['id']; ?>" class="img d-flex align-items-end" style="background-image: url(assets/images/article/<?php echo $articles[$i]['id']; ?>.jpg);">
		    						<div class="overlay"></div>
			    				</a>
			    				<div class="text pt-3">
	    							<p class="meta d-flex"><span class="pr-3"><?php echo ucfirst($articles[$i]['category']); ?></span><span class="ml-auto pl-3"><?php echo $date->format('d F, Y'); ?></span></p>
	    							<h3><a href="article/<?php echo $articles[$i]['id']; ?>"><?php echo $articles[$i]['title']; ?></a></h3>
	    							<p class="mb-0"><a href="article/<?php echo $articles[$i]['id']; ?>" class="btn-custom">Read More <span class="icon-arrow_forward ml-4"></span></a></p>
	    						</div>
		    				</div>
    					</div>
        	...
        	<div class="col-lg-9">
        		...
        		<div class="row">
        			<div class="col-md-4 ftco-animate">
    						<div class="blog-entry">
		    					<a href="/blog" class="img-2"><img src="assets/images/blog-1.jpg" class="img-fluid" alt="Colorlib Template"></a>
			    				<div class="text pt-3">
	    							...
	    							<p class="mb-0"><a href="/blog" class="btn btn-black py-2">Read More <span class="icon-arrow_forward ml-4"></span></a></p>
	    						</div>
		    				</div>
    					</div>
    					<div class="col-md-4 ftco-animate">
    						<div class="blog-entry">
		    					<a href="/blog" class="img-2"><img src="assets/images/blog-2.jpg" class="img-fluid" alt="Colorlib Template"></a>
			    				<div class="text pt-3">
	    							<p class="meta d-flex"><span class="pr-3">Dessert</span><span class="ml-auto pl-3">March 01, 2018</span></p>
	    							<h3><a href="#">Tasty &amp; Delicious Foods</a></h3>
	    							<p class="mb-0"><a href="/blog" class="btn btn-black py-2">Read More <span class="icon-arrow_forward ml-4"></span></a></p>
    					...
    					<div class="col-md-4 ftco-animate">
    						<div class="blog-entry">
		    					<a href="/blog" class="img-2"><img src="assets/images/blog-3.jpg" class="img-fluid" alt="Colorlib Template"></a>
			    				<div class="text pt-3">
	    							<p class="meta d-flex"><span class="pr-3">Dessert</span><span class="ml-auto pl-3">March 01, 2018</span></p>
	    							<h3><a href="#">Tasty &amp; Delicious Foods</a></h3>
	    							<p class="mb-0"><a href="/blog" class="btn btn-black py-2">Read More <span class="icon-arrow_forward ml-4"></span></a></p>
    ...
    <section class="ftco-section ftco-no-pt ftco-section-about ftco-no-pb bg-darken">
    	<div class="container-fluid">
    		<div class="row">
					<div class="col-sm-6 col-md-6 col-lg-9 order-md-last img py-5" style="background-image: url(assets/images/bg_3.jpg);"></div>
        	...
        	<div class="col-md-9">
        		...
        		<div class="row">
        			<div class="col-md-6 col-lg-6 ftco-animate">
		    				<div class="blog-entry">
		    					<div class="img img-big img-big-2 d-flex align-items-end" style="background-image: url(assets/images/image_1.jpg);">
		    						<div class="overlay"></div>
		    						<div class="text">
		    							<span class="subheading">Food</span>
		    			...
		    			<div class="col-md-6 col-lg-6 ftco-animate">
		    				<div class="blog-entry">
		    					<div class="img img-big img-big-2 d-flex align-items-end" style="background-image: url(assets/images/image_3.jpg);">
		    						<div class="overlay"></div>
		    						<div class="text">
        	...
        	<div class="col-md-3">
	            ...
	            <div class="sidebar-box categories text-center ftco-animate">
			          ...
			          <ul class="category-image">
			          	<li>
			          		<a href="foods.html" class="img d-flex align-items-center justify-content-center text-center" style="background-image: url(assets/images/category-1.jpg);">
			          			<div class="text">
			          				<h3>Foods</h3>
			          			</div>
			          		</a>
			          	...
			          	<li>
			          		<a href="lifestyle.html" class="img d-flex align-items-center justify-content-center text-center" style="background-image: url(assets/images/category-2.jpg);">
			          			<div class="text">
			          				<h3>Lifestyle</h3>
			          			</div>
			          		</a>
			          	...
			          	<li>
			          		<a href="#" class="img d-flex align-items-center justify-content-center text-center" style="background-image: url(assets/images/category-2.jpg);">
			          			<div class="text">
			          				<h3>Others</h3>
			          			</div>
			          		</a>
